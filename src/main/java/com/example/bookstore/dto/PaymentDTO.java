...
public class PaymentDTO {
    ...
    private String notes; // Optional notes about the payment
    ...
    // Constructor for request with notes
    public PaymentDTO(Integer orderId, BigDecimal amount, String paymentMethod, String notes) {
        this.orderId = orderId;
        this.amount = amount;
        this.paymentMethod = paymentMethod;
        this.notes = notes;
